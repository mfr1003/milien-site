...
`,
  ...
  FL: {
    name: 'Florida',
    statute: 'Florida Construction Lien Law (Chapter 713, Florida Statutes)',
    documentName: 'Claim of Lien',
    filingOffice: 'Clerk of Circuit Court',
    deadlines: {
      noticeOfFurnishing: {
        days: 45,
        who: 'subcontractors and suppliers not in privity with the owner',
        description: 'Notice to Owner (NTO) must be served within 45 days of first furnishing labor or materials. Required for all lienors not in direct contract with the owner.',
        required: true,
        conditionalNote: 'Not required for contractors in direct privity with the owner.',
      },
      claimOfLien: {
        residential: 90,
        commercial: 90,
        description: 'Claim of Lien must be recorded within 90 days of last furnishing labor, services, or materials.',
      },
      serveOwner: {
        days: 15,
        description: 'A copy of the recorded Claim of Lien must be served on the property owner before recording or within 15 days after recording.',
      },
      enforce: {
        description: 'Lien enforcement action must be filed within 1 year of recording, unless the owner files a Notice of Contest of Lien, which shortens the period to 60 days.',
      },
    },
    counties: [
      'Miami-Dade', 'Broward', 'Palm Beach', 'Hillsborough', 'Orange',
      'Pinellas', 'Duval', 'Lee', 'Polk', 'Brevard', 'Volusia', 'Sarasota',
      'Manatee', 'Collier', 'Seminole', 'Pasco', 'Alachua', 'Leon',
      'Marion', 'Osceola', 'Other Florida County'
    ],
    documentPrompt: (data, today, lienDeadlineStr, daysRemaining) => `
You are a Florida construction lien document preparation specialist with deep knowledge of the Florida Construction Lien Law (Chapter 713, Florida Statutes).

APPLICABLE LAW: Florida Construction Lien Law, Chapter 713, Florida Statutes
FILING OFFICE: ${data.propertyCounty} County Clerk of Circuit Court
CLAIM OF LIEN DEADLINE: ${lienDeadlineStr} (${daysRemaining} days remaining)
STATUTE OF LIMITATIONS: 1 year from recording to enforce lien (or 60 days if owner files Notice of Contest of Lien)

KEY FLORIDA REQUIREMENTS:
- Subcontractors and suppliers not in privity with owner must serve Notice to Owner (NTO) within 45 days of first furnishing
- Claim of Lien must be recorded within 90 days of last furnishing — applies to both residential and commercial
- A copy of the Claim of Lien must be served on the owner before recording OR within 15 days after recording
- Florida courts require STRICT compliance — minor errors (wrong dates, incorrect legal description) can void the lien
- Filed with the Clerk of Circuit Court in the county where the property is located
- Must include the legal description of the property — the street address alone is not sufficient

NOTARIZATION BLOCK FORMAT:
State of Florida
County of ___________________
Before me, the undersigned authority, personally appeared the above-named claimant who, being duly sworn, states that the foregoing is true and correct.
Sworn to and subscribed before me this _______ day of _________________, 20____.
...
function getNoticeDeadlineDays(stateCode, role, projectType, projectSubtype) {
  ...
  if (stateCode === 'FL') {
    return (role !== 'General Contractor / Prime') ? 45 : null;
  }
...
const AUTO_MODULES = {
  ...
  FL: {
    name: 'Florida',
    statute: 'Florida Statutes § 713.585',
    filingAgency: 'Florida Department of Highway Safety and Motor Vehicles (FLHSMV) via approved third-party vendor',
    filingCoordinationAvailable: false,
    filingCoordinationNote: 'Florida law requires all lien notices to be sent through FLHSMV-approved third-party vendors (Beacon Software or Auto Data Direct). LodgeMiLien cannot coordinate FL automotive filing directly. We prepare your demand letter and compliance guide only.',
    deadlines: {
      filingDeadline: 7,
      description: 'Notice of lien must be sent via FLHSMV-approved third-party vendor within 7 business days of repair completion.',
      holdDeadline: 60,
      holdDescription: 'Vehicle must be held a minimum of 60 days before sale.',
      saleNoticeDeadline: 15,
      saleNoticeDescription: 'Newspaper advertisement must run 15 days before scheduled sale date.',
      titleDeadline: 30,
      titleDescription: 'Minimum 30 days must pass after lien notice is sent before applying for title.',
    },
  },
};
...
- Signed work order from vehicle owner is required to assert lien rights`,
    ...
    FL: `- Lien attaches to the VEHICLE under Florida Statutes § 713.585
- Repair must have been authorized by the vehicle owner or customer (signed estimate/work order required under Florida Motor Vehicle Repair Act, s. 559.905)
- CRITICAL: Notice of lien MUST be sent through an FLHSMV-approved third-party vendor (Beacon Software or Auto Data Direct) — shops cannot send notices directly
- Notice must be sent within 7 BUSINESS DAYS of repair completion to: registered owner, customer on repair order, and all lienholders of record per FLHSMV title records
- Notice must include: itemized charges, storage rate per day, administrative fee (not to exceed $250), and date/time/place of proposed sale
- Vehicle must be available for inspection within 3 business days of written request from any notice recipient
- Minimum 30 days must pass after lien notice is sent before applying for title transfer
- Vehicle must be held for a minimum of 60 days (not counting day of repair completion or day of sale) before sale
- Newspaper advertisement must run 15 days before the scheduled sale date
- Sale price must be the amount due in cash on the day of sale
- After sale: apply proceeds to lien first; surplus to be deposited with Clerk of Circuit Court
- Title transfer uses HSMV 82040 MV (Application for Certificate of Motor Vehicle Title)
- Filing is with County Clerk of Courts — $10 service charge for certificate of compliance`
  };
...
IMPORTANT: Violating I.C. § 9-22-6-2 procedures is a Class A infraction. Follow each step precisely. If you have released the vehicle and the owner still owes you, a different lien process applies (I.C. § 32-33-10). Consult an Indiana attorney in that situation.`,
    ...
    FL: `═══════════════════════════════════════
DOCUMENT 2: FLORIDA § 713.585 COMPLIANCE GUIDE
Florida Lien by Sale of Motor Vehicle — Process Reference
═══════════════════════════════════════

IMPORTANT NOTICE: Florida law requires all lien notices to be sent through an FLHSMV-approved third-party mailing vendor. LodgeMiLien prepares your documents and provides this guide, but you must engage Beacon Software (beaconsoftware.com) or Auto Data Direct (add123.com) to send the official Notice of Lien to the owner and all lienholders. Failure to use an approved vendor will result in your title application being rejected.

NOTICE OF LIEN REQUIREMENTS (must be sent within 7 business days of repair completion):
...
Repair authorized by: ${ownerName}
Date repairs completed: ${dateLast}
Amount due: $${parseInt(amountOwed).toLocaleString()}
Storage charges: $________ per day (fill in your daily rate)
Administrative fee: $________ (cannot exceed $250 under Florida law)

The notice must state that the vehicle is subject to enforcement under § 713.585, Florida Statutes, and that unless the amount due is paid, the vehicle may be sold. The notice must also state the vehicle is available for inspection within 3 business days of written request.

TIMELINE AFTER NOTICE IS SENT:
Day 0: Notice sent via approved third-party vendor
Day 30 minimum: Earliest you may apply for title transfer
Day 45 minimum: Newspaper ad must run no less than 15 days before sale
Day 60 minimum: Earliest the vehicle may be sold
Sale date: Must be publicly announced in a newspaper of general circulation

TITLE TRANSFER AFTER SALE:
Use HSMV 82040 MV — Application for Certificate of Motor Vehicle Title. File with the County Clerk of Courts along with your certificate of compliance ($10 filing fee). The approved third-party vendor will provide documentation of the notices sent, which must accompany your title application.`
  };
  ...
  const licenseField = stateCode === 'MI'
    ...
    : stateCode === 'FL'
      ? `Florida Motor Vehicle Repair Act registration: ${licenseNumber || 'N/A — confirm compliance with s. 559.905, F.S.'}`
...
TOTAL PROCESS LIMIT: 225 days from lien attachment date`
    : stateCode === 'FL'
      ? `NOTICE DEADLINE: Within 7 business days of repair completion (${filingDeadlineStr})
MINIMUM HOLD: 60 days before sale — MINIMUM WAIT FOR TITLE: 30 days after notice sent
CRITICAL: Notice MUST be sent via FLHSMV-approved third-party vendor (Beacon Software or Auto Data Direct)`
      : '';
